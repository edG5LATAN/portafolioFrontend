    ...
    <div className="container sobremi_contenedor">
      <div className="sobremi_contenedor_info">
        ...
        <p className="p-2">
          ...
          con Alura Latam, Udemy -certificados en JavaScript, HTML, CSS, JS,
          Bootstrap, TypeScript, WordPress, WooCommerce, React, Java, SpringBoot, Express, NodeJS,
          GitHub, Base de datos MYSQL, MongoDB, conocimiento en base de datos
          ORACLE.
        </p>
