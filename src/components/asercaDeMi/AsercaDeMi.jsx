      ...
      <div className="card border-info mb-3 aserca_de_mi_contenedor">
        ...
        <div className="card-body">
          <p className="card-text p-3">
            ...
            Con conocimiento en Backend en Express de NodeJS, Spring Boot, SpringSecurity de Java.<br/>
            Desarrollo de paginas web con WordPress y manejo de WooCommerce para paginas ventas online.<br/>
