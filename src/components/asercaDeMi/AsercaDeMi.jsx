...
function AsercaDeMi() {
  return (
    <div className="container asercademi_contenedor">
      <div class="card border-info mb-3 aserca_de_mi_contenedor">
        <div class="card-header text-center fw-bold text-uppercase">Aserca de mi</div>
        <div class="card-body">
          <p class="card-text p-3">
            ...
            Base da datos MYSQL ORACLE con certificacion de ALURA LATAM, ORCALE y UDEMY. Da click a Proyectos ahi podras ver algunos de los trabajos realizados.
          </p>
        </div>
      </div>
    </div>
