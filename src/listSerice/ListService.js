export const listEstudios = ([{
  imagen: "./img/estudios/alura1.webp",
  nombre: "Alura Latan",
  descripcion:
...
{
  imagen: "./img/estudios/udemy.webp",
  nombre: "UDEMY",
  descripcion:
...
{
  imagen: "./img/estudios/universidadPedagogica.webp",
...
export const listHobies=[
  {
    nombre:"Developer",
    imagen:"./img/pasatiempos/aprender.webp",
  },
  {
    nombre:"Baloncesto",
    imagen:"./img/pasatiempos/baloncesto.webp",
  },
  {
    nombre:"codificar",
    imagen:"./img/pasatiempos/codificar.webp",
  },
  {
    nombre:"manga",
    imagen:"./img/pasatiempos/manga.webp",
  },
  {
    nombre:"reparar",
    imagen:"./img/pasatiempos/reparar.webp",
  },
  {
    nombre:"videojuegos",
    imagen:"./img/pasatiempos/videojuegos.webp",
  }
]
